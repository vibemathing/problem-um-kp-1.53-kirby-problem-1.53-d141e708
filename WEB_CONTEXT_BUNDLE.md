...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.53-kirby-problem-1.53-d141e708-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.53"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.53-kirby-problem-1.53-d141e708-v1",
      "problem_contract_sha256": "f34a13d697dc7be782c4a41389685ed027dbd1629b1237b9e2920ad4b0a0223e",
      "problem_id": "problem:um-kp-1.53-kirby-problem-1.53-d141e708",
      "route_id": "route:um-kp-1.53-kirby-problem-1.53-d141e708-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.53-kirby-problem-1.53-d141e708-source-fidelity-01",
      "graph_id": "graph:um-kp-1.53-kirby-problem-1.53-d141e708-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.53-kirby-problem-1.53-d141e708-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.53-kirby-problem-1.53-d141e708-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Which knot properties are hereditary under ribbon concordance? Is the property of being alternating hereditary under ribbon concordance? (b) Which knot properties imply minimality under ribbon concordance? Are positive knots minimal under ribbon concordance? (c) Which knot invariants are monotone under ribbon concordance? Is cross- ing number, bridge number, or braid index monotone under ribbon con- cordance?"
          },
          "statement_sha256": "16419656a23f1afad725601282578409ecda760ca7d7dc2559bc8aeb16466137"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.53-kirby-problem-1.53-d141e708-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.53-kirby-problem-1.53-d141e708-root",
      "route_id": "route:um-kp-1.53-kirby-problem-1.53-d141e708-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.53-0ad52583efbe",
        "url": "https://www.unsolvedmath.com/problems/KP-1.53"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
